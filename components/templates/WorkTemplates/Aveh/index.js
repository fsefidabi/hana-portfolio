...
import work from "constants/data/works/aveh.json"

function AvehWorkTemplate({ clickPosition, zoomedSize, handleImageClick }) {
    return (
        <div className={`contentWrapper mt-16 ${styles.container}`}>
            ...
            <motion.div
                className={`contentWrapper ${styles.container} mb-6`}
                initial={"initial"}
                whileInView="animate"
                viewport={{ once: true }}
                variants={textReveal.parentVariantsWithStaggerChildren(1)}
            >
                <motion.div
                    ...
                    transition={{ duration: 2 }}
                >
                    {work.title1.length > 0 ? work.title1?.map((item, index) => (
                        item?.children?.map(child => (
                            <p
                                key={index}
            ...
            >
                <motion.div
                    ...
                    transition={{ duration: 2 }}
                >
                    {work.title2.length > 0 ? work.title2?.map((item, index) => (
                        item?.children?.map(child => (
                            <p
                                key={index}
                                className={"whitespace-nowrap font-semibold"}
            ...
            >
                <motion.div
                    ...
                    transition={{ duration: 2 }}
                >
                    {work.title3.length > 0 ? work.title3?.children?.map((child, index) => (
                        <p
                            key={index}
                            className={"whitespace-nowrap font-semibold"}
                        >
            ...
            >
                <motion.div
                    ...
                    transition={{ duration: 2 }}
                >
                    {work.title3.length > 0 ? work.title3?.map((item, index) => (
                        item?.children?.map(child => (
                            <p
                                key={index}
                                className={"whitespace-nowrap font-semibold"}
            ...
            >
                <motion.div
                    ...
                    transition={{ duration: 2 }}
                >
                    {work.title4.length > 0 ? work.title4?.children?.map((child, index) => (
                        <p
                            key={index}
                            className={"whitespace-nowrap font-semibold"}
                        >
            ...
            >
                <motion.div
                    ...
                    transition={{ duration: 2 }}
                >
                    {work.title4.length > 0 ? work.title4?.map((item, index) => (
                        item?.children?.map(child => (
                            <p
                                key={index}
                                className={"whitespace-nowrap font-semibold"}
...
export default AvehWorkTemplate
